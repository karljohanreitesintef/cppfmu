...
public:
  using LoggerFunction = std::function<void(
      cppfmu::FMIStatus, cppfmu::FMIString, cppfmu::FMIString)>;
...
cppfmu::UniquePtr<cppfmu::SlaveInstance3> CppfmuInstantiateSlave(
    ...
    cppfmu::FMIString /*resourceLocation*/, cppfmu::FMIBoolean /*visible*/,
    cppfmu::FMIBoolean /*loggingOn*/, cppfmu::FMIBoolean /*eventModeUsed*/,
