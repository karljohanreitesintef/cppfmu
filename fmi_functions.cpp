...
struct Component {
  Component(cppfmu::FMIString instanceName,
      ...
      : memory{callbackFunctions},
        ...
        ,
        logger{this, cppfmu::CopyString(memory, instanceName),
               callbackFunctions, loggerSettings}
#else
        ,
        logger{callbackFunctions.componentEnvironment,
               cppfmu::CopyString(memory, instanceName), callbackFunctions,
               loggerSettings}
#endif
        ,
...
cppfmu::FMIStatus RunCall(cppfmu::FMIComponent c, const char *functionName,
                          Operation operation) {
...
fmiComponent fmiInstantiateSlave(fmiString instanceName, fmiString fmuGUID,
  ...
  try {
    auto component = cppfmu::AllocateUnique<Component>(
        cppfmu::Memory{functions}, instanceName, functions, loggingOn);
    component->slave = CppfmuInstantiateSlave(
        instanceName, fmuGUID, fmuLocation, mimeType, timeout, visible,
        interactive, component->memory, component->logger);
...
fmiStatus fmiResetSlave(fmiComponent c) {
  return RunCall(c, "fmiResetSlave",
                 [&](cppfmu::SlaveInstance &slave) { slave.Reset(); });
}

fmiStatus fmiTerminateSlave(fmiComponent c) {
  return RunCall(c, "fmiTerminateSlave",
                 [&](cppfmu::SlaveInstance &slave) { slave.Terminate(); });
}
...
fmiStatus fmiSetRealInputDerivatives(fmiComponent c,
                                     ...
                                     const fmiReal value[]) {
  return RunCall(c, "fmiSetRealInputDerivatives",
...
fmiStatus fmiGetRealOutputDerivatives(fmiComponent c,
                                      ...
                                      const fmiInteger order[],
                                      fmiReal value[]) {
  return RunCall(c, "fmiGetRealOutputDerivatives",
                 [&](cppfmu::SlaveInstance &slave) {
...
fmiStatus fmiCancelStep(fmiComponent c) {
  reinterpret_cast<Component *>(c)->logger.Log(
      fmiError, "cppfmu", "FMI function not supported: fmiCancelStep");
  return fmiError;
}
...
fmiStatus fmiDoStep(fmiComponent c, fmiReal currentCommunicationPoint,
  ...
  try {
    ...
    const auto ok = component->slave->DoStep(
        currentCommunicationPoint, communicationStepSize, newStep, endTime);
    if (ok) {
...
fmiStatus fmiGetStatus(fmiComponent c, const fmiStatusKind /*s*/,
                       fmiStatus * /*value*/) {
  reinterpret_cast<Component *>(c)->logger.Log(
      fmiError, "cppfmu", "FMI function not supported: fmiGetStatus");
  return fmiError;
}
...
fmiStatus fmiGetRealStatus(fmiComponent c, const fmiStatusKind s,
  ...
  if (s == fmiLastSuccessfulTime) {
    *value = component->lastSuccessfulTime;
    ...
    component->logger.Log(fmiError, "cppfmu",
...
fmiStatus fmiGetIntegerStatus(fmiComponent c, const fmiStatusKind /*s*/,
                              fmiInteger * /*value*/) {
  reinterpret_cast<Component *>(c)->logger.Log(
      fmiError, "cppfmu", "FMI function not supported: fmiGetIntegerStatus");
  return fmiError;
}
...
fmiStatus fmiGetBooleanStatus(fmiComponent c, const fmiStatusKind /*s*/,
                              fmiBoolean * /*value*/) {
  reinterpret_cast<Component *>(c)->logger.Log(
      fmiError, "cppfmu", "FMI function not supported: fmiGetBooleanStatus");
  return fmiError;
}
...
fmiStatus fmiGetStringStatus(fmiComponent c, const fmiStatusKind /*s*/,
                             fmiString * /*value*/) {
  reinterpret_cast<Component *>(c)->logger.Log(
      fmiError, "cppfmu", "FMI function not supported: fmiGetStringStatus");
  return fmiError;
}
...
fmi2Component fmi2Instantiate(fmi2String instanceName, fmi2Type fmuType,
  ...
  try {
    if (fmuType != fmi2CoSimulation) {
      throw std::logic_error("Unsupported FMU instance type requested (only "
    ...
    component->slave = CppfmuInstantiateSlave(
        ...
        "application/x-fmu-sharedlibrary", 0.0, visible, cppfmu::FMIFalse,
        component->memory, component->logger);
    return component.release();
  } catch (const cppfmu::FatalError &e) {
...
fmi2Status fmi2SetupExperiment(fmi2Component c, fmi2Boolean toleranceDefined,
  ...
  return RunCall(c, "fmi2SetupExperiment", [&](cppfmu::SlaveInstance &slave) {
    slave.SetupExperiment(toleranceDefined, tolerance, startTime,
...
fmi2Status fmi2Terminate(fmi2Component c) {
  return RunCall(c, "fmi2Terminate",
                 [&](cppfmu::SlaveInstance &slave) { slave.Terminate(); });
}

fmi2Status fmi2Reset(fmi2Component c) {
  return RunCall(c, "fmi2Reset",
                 [&](cppfmu::SlaveInstance &slave) { slave.Reset(); });
}
...
fmi2Status fmi2SerializedFMUstateSize(fmi2Component c, fmi2FMUstate state,
                                      size_t *size) {
  return RunCall(c, "fmi2SerializedFMUstateSize",
                 [&](cppfmu::SlaveInstance &slave) {
                   *size = slave.SerializedFMUStateSize(state);
                 });
}

fmi2Status fmi2SerializeFMUstate(fmi2Component c, fmi2FMUstate state,
                                 fmi2Byte data[], size_t size) {
  return RunCall(c, "fmi2SerializeFMUstate", [&](cppfmu::SlaveInstance &slave) {
    slave.SerializeFMUState(state, data, size);
  });
}

fmi2Status fmi2DeSerializeFMUstate(fmi2Component c, const fmi2Byte data[],
                                   size_t size, fmi2FMUstate *state) {
  return RunCall(c, "fmi2DeSerializeFMUstate",
                 [&](cppfmu::SlaveInstance &slave) {
...
fmi2Status fmi2GetDirectionalDerivative(fmi2Component c,
                                        ...
                                        size_t nKnown, const fmi2Real dvKnown[],
                                        fmi2Real dvUnknown[]) {
  return RunCall(
      c, "fmi2GetDirectionalDerivative", [&](cppfmu::SlaveInstance &slave) {
        slave.GetDirectionalDerivative(vUnknown_ref, nUnknown, vKnown_ref,
                                       nKnown, dvKnown, dvUnknown);
      });
}
...
fmi2Status fmi2SetRealInputDerivatives(fmi2Component c,
  ...
  return RunCall(c, "fmi2SetRealInputDerivatives",
                 [&](cppfmu::SlaveInstance &slave) {
                   slave.SetRealInputDerivatives(vr, nvr, order, value);
                 });
}
...
fmi2Status fmi2GetRealOutputDerivatives(fmi2Component c,
                                        ...
                                        size_t nvr, const fmi2Integer order[],
                                        fmi2Real value[]) {
  return RunCall(c, "fmi2GetRealOutputDerivatives",
                 [&](cppfmu::SlaveInstance &slave) {
                   slave.GetRealOutputDerivatives(vr, nvr, order, value);
                 });
}
...
fmi2Status fmi2DoStep(fmi2Component c, fmi2Real currentCommunicationPoint,
  ...
  try {
    double endTime = currentCommunicationPoint;
    const auto ok = component->slave->DoStep(
        currentCommunicationPoint, communicationStepSize, fmi2True, endTime);
    if (ok) {
      component->lastSuccessfulTime =
          currentCommunicationPoint + communicationStepSize;
      return fmi2OK;
...
fmi2Status fmi2GetRealStatus(fmi2Component c, const fmi2StatusKind s,
  ...
  if (s == fmi2LastSuccessfulTime) {
    *value = component->lastSuccessfulTime;
    ...
    component->logger.Log(fmi2Error, "cppfmu",
