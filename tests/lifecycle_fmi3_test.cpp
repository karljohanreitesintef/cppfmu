...
const State kAllStates[] = {
    State::Instantiated, State::Initialization, State::Step,
    State::Event,        State::Terminated,     State::Failed,
};
...
int main() {
  ...
  AssertLegalIn(LifecycleCall::Terminate,
                {State::Initialization, State::Step, State::Event});
  AssertLegalIn(LifecycleCall::Reset,
                {State::Instantiated, State::Initialization, State::Step,
                 State::Event, State::Terminated, State::Failed});
  ...
  AssertLegalIn(
      ...
      {State::Instantiated, State::Initialization, State::Step, State::Event});
  AssertLegalIn(LifecycleCall::ReadVariable,
                {State::Instantiated, State::Initialization, State::Step,
                 State::Event, State::Terminated});
  ...
  // from any state.
  AssertLegalIn(LifecycleCall::SnapshotMemory,
                {State::Instantiated, State::Initialization, State::Step,
                 State::Event, State::Terminated, State::Failed});
  AssertLegalIn(LifecycleCall::FmuStateRead,
                {State::Instantiated, State::Initialization, State::Step,
                 State::Event, State::Terminated});
  AssertLegalIn(LifecycleCall::FmuStateRestore,
                {State::Instantiated, State::Initialization, State::Step,
                 State::Event, State::Terminated, State::Failed});
  ...
  AssertLegalIn(LifecycleCall::EvaluateDiscreteStates,
  ...
  AssertTransition(State::Instantiated, LifecycleCall::EnterInitialization,
                   State::Initialization);
  AssertTransition(State::Initialization, LifecycleCall::ExitInitialization,
                   State::Step);
  ...
  AssertTransition(State::Initialization, LifecycleCall::Terminate,
                   State::Terminated);
